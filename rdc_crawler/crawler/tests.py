...
class FindLinksTest(TestCase):
    ...
    def test_find_links_ok(self):
        links = find_links(self.doc['_id'])[0]
        self.assertSetEqual(set(links),
            set([u'http://rdc-blga.appspot.com/html/genindex.html',
             u'http://rdc-blga.appspot.com/html/source/classes.html',
             u'http://rdc-blga.appspot.com/html/_images/schema.png',
             u'http://rdc-blga.appspot.com/html/source/classes.html',
             u'http://rdc-blga.appspot.com/html/genindex.html',
             u'http://rdc-blga.appspot.com/html/search.html',
             u'http://rdc-blga.appspot.com/html/_sources/index.txt',
             u'http://rdc-blga.appspot.com/html/genindex.html',
             u'http://sphinx.pocoo.org/']))

    def test_parseable_ok(self):
        for link in [ u'http://sphinx.pocoo.org/',
                     u'http://python.org/']:
    ...
    def test_parseable_fail(self):
        for link in ['test.js' , 'test.css', 'test.zip', 'test.jpg',
            ...
            'http://rdc-blga.appspot.com/html/_images/schema.png',
            'mailto:example@example.com', 'http://rdc-blga.appspot.com/html',
